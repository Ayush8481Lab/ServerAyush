...
export default async function handler(req, res) {
  ...
  try {
    ...
    page.on('request', (interceptedRequest) => {
      ...
      if (interceptedRequest.url().includes('com.htdigital.streams/tp2')) {
    ...
    await page.goto('https://epaper.livehindustan.com/delhi?eddate=29/04/2026', { waitUntil: 'networkidle2' });
